...
- [Running the server](#folder-structure)
- [Modules](#available-scripts)
  - [What is a module](#npm-start)
  - [New modules](#npm-test)
  - [Installing new modules](#npm-run-build)
  - [Configuration](#npm-run-eject)
- [Forms](#supported-language-features-and-polyfills)
- [Rest Services](#syntax-highlighting-in-the-editor)
- [Authentication](#displaying-lint-output-in-the-editor)
- [GraphQL](#debugging-in-the-editor)
- [WebSockets](#formatting-code-automatically)
