...
const MaterialTableUIOptions: Reactory.Client.Components.IMaterialTableWidgetOptions =
  {
      ...
      // Workflow Full ID - Copyable
      {
        ...
        props: {
          uiSchema: {
            "ui:options": {
              format:
                "/workflows/registry/${rowData.nameSpace}.${rowData.name}@${rowData.version}",
              title: "${rowData.name}",
              icon: "navigate_next",
              showLabel: false,
              sx: {
    ...
    actions: [
      ...
      },
      {
        ...
        tooltip:
          '${rowData.isActive ? "Deactivate this workflow" : "Activate this workflow"}',
        confirmation: {
          key: "confirm",
          acceptTitle: '${rowData.isActive ? "DEACTIVATE" : "ACTIVATE"}',
          cancelTitle: "CANCEL",
          content:
            '${rowData.isActive ? "Are you sure you want to deactivate" : "Are you sure you want to activate"} ${rowData.nameSpace}.${rowData.name}?',
