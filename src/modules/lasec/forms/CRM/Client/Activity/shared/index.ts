...
export const InvoiceFilterByEnumArray: string[] = [
  ...
  InvoiceFilterByEnumsKeys.customer_account_number,
...
export const InvoiceFilterByOptions = [
  ...
  { key: InvoiceFilterByEnumsKeys.customer_account_number, value: InvoiceFilterByEnumsKeys.customer_account_number, label: 'Customer Account Number' },
