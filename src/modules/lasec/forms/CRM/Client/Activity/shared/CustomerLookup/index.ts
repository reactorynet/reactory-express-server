...
const LasecCRMClientActivityCustomerLookupForm: Reactory.IReactoryForm = {
  id: 'LasecCRMClientActivityCustomerLookupTable',
  uiFramework: 'material',
  uiSupport: ['material'],
  uiResources: [],
  title: 'CRM Client Activity Customer Lookup Table',
  tags: ['CRM Client Activity Customer Lookup Table'],
  registerAsComponent: true,
  name: 'LasecCRMClientActivityCustomerLookupTable',
  nameSpace: 'lasec-crm',
  version: '1.0.0',
  schema: schema,
  uiSchema: uiSchema,
...
export default LasecCRMClientActivityCustomerLookupForm;
