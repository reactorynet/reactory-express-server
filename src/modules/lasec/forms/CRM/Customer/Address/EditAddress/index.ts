...
const LasecCRMEditCustomerAddress: Reactory.IReactoryForm = {
  id: 'LasecCRMEditCustomerAddress',
  ...
  name: 'LasecCRMEditCustomerAddress',
  nameSpace: 'lasec-crm',
  version: '1.0.0',
  schema: schema,
  graphql: $graphql,
...
export default LasecCRMEditCustomerAddress;
