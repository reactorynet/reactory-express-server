...
const uiSchema: any = {
    ...
    tenders: {
        ...
        'ui:options': {
            ...
            resultMap: {
                'tenders.[].id': 'data.[].id',
                'tenders.[].company_id': 'data.[].company_id',
                'tenders.[].grand_total_excl_vat_cents': 'data.[].grand_total_excl_vat_cents',
                'tenders.[].name': 'data.[].name',
                'tenders.[].expiry_date': 'data.[].expiry_date',
                'tenders.[].reference': 'data.[].reference',
                'tenders.[].unit_of_measure': 'data.[].unit_of_measure',
                'tenders.[].description': 'data.[].description',
            },
        },
    }
};
...
const LasecProductTenders: Reactory.IReactoryForm = {
    id: 'LasecProductTenders',
...
export default LasecProductTenders;
