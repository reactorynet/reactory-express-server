...
export default {
  query: {
    ...
    variables: {
      ...
      'formData.toolbar.productClass': 'dashparams.productClass'
    },
    resultMap: {
      id: 'id',
      ...
      'quotes[].productClass': 'quotes[].productClass',
      'quotes[].productClassDescription': 'quotes[].productClassDescription',
