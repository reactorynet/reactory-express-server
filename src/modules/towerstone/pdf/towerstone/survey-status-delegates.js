...
const resolveData = async ({ surveyId, delegateId, context }) => {
  ...
  try {
    if (survey) survey.addTimelineEntry(SURVEY_EVENTS_TO_TRACK.REPORT_GENERATED, `Survey status report generated by ${user.firstName} ${user.lastName}.`, user._id, true);
