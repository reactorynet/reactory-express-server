...
const resolveData = async ({ surveyId, delegateId }) => {
  ...
  try {
    ...
    if (survey) survey.addTimelineEntry(SURVEY_EVENTS_TO_TRACK.REPORT_GENERATED, `Delegate 180 assessment report generated by ${user.firstName} ${user.lastName}.`, user._id, true);
