...
const resolveData = async ({ surveyId, delegateId, print_scores }) => {
  ...
  try {
    ...
    try {
      ...
      if (survey) if (survey) survey.addTimelineEntry(SURVEY_EVENTS_TO_TRACK.REPORT_GENERATED, `Team 180 report generated by ${user.firstName} ${user.lastName}.`, user._id, true);
