module.exports = {
  apps: [{
    ...
    env: {
      ...
      MONGOOSE: 'mongodb://reactorycore:<MONGO_PASSWORD>@localhost:27017/reactory',
      WORKFLOW_MONGO: 'mongodb://reactorycore:<MONGO_PASSWORD>@localhost:27017/reactory-workflow',
      API_PORT: 4000,
